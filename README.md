...
EzErgo Overlay 是一個鍵盤提示應用程式，用於顯示 Vial 鍵盤的鍵位。它會在螢幕上顯示一個半透明的覆蓋視窗，即時顯示當前鍵盤層的按鍵配置。感謝AI讓我快速開發了這個小APP。它是我熟悉自製分離式鍵盤的救星😂

這個程式還有很多Bug，Layout切換目前也只有支援MO鍵。歡迎提交PR或提供建議

![demo](docs/app_window.png)
